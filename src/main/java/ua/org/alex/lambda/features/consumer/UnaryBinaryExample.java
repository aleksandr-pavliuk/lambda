...
public class UnaryBinaryExample {
    ...
    private static UnaryOperator<String> uo1 = name -> name.toUpperCase();

    private static UnaryOperator<Integer> uo2 = a -> a + 10;

    private static Comparator<Integer> comp = (a, b) -> a.compareTo(b);
